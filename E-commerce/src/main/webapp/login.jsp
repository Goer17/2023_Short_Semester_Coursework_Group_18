...
<body>
<div class="cent">
<form method="post" action="./login" style="text-align: center;" class="form-box"> 
<div class="form-item"><span>username :</span> <input class="form-input" type="text" name="username"/><br/></div>
<div class="form-item"><span>password :</span> <input class="form-input" type="password" name="password"/><br/></div>
	<input type="SUBMIT" name="submit" value="Login" class="form-submit-button">
	<a href="register.jsp" class="form-submit-register">register</a>
</form>
</div>
